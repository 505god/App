...
@interface WQProductVC ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,WQNavBarViewDelegate,WQProductDetailVCDelegate>
