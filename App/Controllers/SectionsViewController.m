...
- (void)viewDidLoad {
    ...
    //导航栏
    [self.navBarView setTitleString:NSLocalizedString(@"countrychoose", @"")];
    ...
    search.frame=CGRectMake(0, self.navBarView.bottom, self.view.frame.size.width, 44);
    [self.view addSubview:search];
    
    table=[[UITableView alloc] initWithFrame:CGRectMake(0, search.bottom, self.view.frame.size.width, self.view.bounds.size.height-(search.bottom)) style:UITableViewStylePlain];
