...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.starView = [[WQStarView alloc]initWithFrame:(CGRect){0,0,100,30} enable:YES];
...
-(void)layoutSubviews {
    ...
    self.starView.frame = (CGRect){self.contentView.width-self.starView.width+10,(self.contentView.height-self.starView.height)/2,self.starView.width,self.starView.height};
