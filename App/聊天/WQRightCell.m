...
-(void)setClassObj:(WQClassObj *)classObj {
    _classObj = classObj;
    self.titleLab.text = [NSString stringWithFormat:@"%@  (%ld)",classObj.className,classObj.levelClassCount];
}
-(void)setLevelClassObj:(WQClassLevelObj *)levelClassObj {
    _levelClassObj = levelClassObj;
    
    self.titleLab.text = [NSString stringWithFormat:@"%@  (%ld)",levelClassObj.levelClassName,levelClassObj.productCount];
}
//颜色
-(void)setColorObj:(WQColorObj *)colorObj {
    _colorObj = colorObj;
    self.titleLab.text = [NSString stringWithFormat:@"%@  (%ld)",colorObj.colorName,colorObj.productCount];
}

//尺码
-(void)setSizeObj:(WQSizeObj *)sizeObj {
    _sizeObj = sizeObj;
    self.titleLab.text = [NSString stringWithFormat:@"%@  (%ld)",sizeObj.sizeName,sizeObj.productCount];
}
